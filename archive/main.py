...
def count_fingers_raised(rgb_image, detection_result: HandLandmarkerResult):
   ...
   try:
      ...
      if (numRaised[0] == 1):
         controller.writeMsg("to")
         controller.readMsg()
      else:
         controller.writeMsg("tc")
         controller.readMsg()

      if (numRaised[1] == 1):
         controller.writeMsg("io")
         controller.readMsg()
      else:
         controller.writeMsg("ic")
         controller.readMsg()
        
      if (numRaised[2] == 1):
         controller.writeMsg("mo")
         controller.readMsg()
      else:
         controller.writeMsg("mc")
         controller.readMsg()

      if (numRaised[3] == 1):
         controller.writeMsg("ro")
         controller.readMsg()
      else:
      ...
      if (numRaised[4] == 1):
         controller.writeMsg("lo")
         controller.readMsg()
      else:
         controller.writeMsg("lc")
         controller.readMsg()
